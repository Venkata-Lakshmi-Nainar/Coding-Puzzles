...
Given : A Stack containing elements in unsorted order

To Do : Sort stack such that the greater element is always pushed on the smaller element

Example:

Input : Stack (S) = { 23, 786, 12, 76 , 30 , 9 }

Output: { 9 , 12 , 23 , 30 , 76 , 786 }
*/
